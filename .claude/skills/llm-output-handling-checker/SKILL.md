---
name: "llm-output-handling-checker"
...
inputs: ["output consumption paths", "rendering surfaces", "automation hooks", "tool-calling behavior", "response post-processing"]
outputs: ["output handling findings", "unsafe sink inventory", "validation and escaping recommendations", "approval requirements", "recommended next skill"]
handoffs: ["prompt-injection-reviewer", "tool-permission-boundary-checker", "secret-exposure-reviewer"]
---

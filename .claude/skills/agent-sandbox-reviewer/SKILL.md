...
inputs: ["runtime environment", "filesystem access", "network access", "credential model", "execution controls"]
outputs: ["sandbox review", "containment findings", "runtime hardening recommendations", "environment risk summary", "recommended next skill"]
handoffs: ["tool-permission-boundary-checker", "secret-exposure-reviewer", "guardrail-policy-writer"]
---
# agent-sandbox-reviewer

## Purpose
Review whether the runtime environment constrains filesystem, network, process, credential, and external side effects to acceptable boundaries.

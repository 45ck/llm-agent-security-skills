...
inputs: ["agent goals", "tool capabilities", "approval workflow", "task categories", "failure scenarios"]
outputs: ["agency risk summary", "unsafe autonomy findings", "gating recommendations", "escalation rules", "recommended next skill"]
handoffs: ["tool-permission-boundary-checker", "agent-sandbox-reviewer", "guardrail-policy-writer"]
---
# agent-agency-reviewer

## Purpose
Review whether the agent has excessive autonomy relative to the task, risk level, and available safeguards.

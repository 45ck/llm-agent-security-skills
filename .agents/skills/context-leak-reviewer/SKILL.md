...
inputs: ["system prompts", "memory/context design", "response examples", "tool outputs", "logging and transcript behavior"]
outputs: ["context leak findings", "leak paths", "redaction requirements", "isolation recommendations", "recommended next skill"]
handoffs: ["secret-exposure-reviewer", "llm-output-handling-checker", "guardrail-policy-writer"]
---
# context-leak-reviewer

## Purpose
Review whether hidden prompts, private context, prior conversation state, or system metadata can leak through outputs or retrieved artifacts.
...
- response examples
- tool outputs
- logging and transcript behavior

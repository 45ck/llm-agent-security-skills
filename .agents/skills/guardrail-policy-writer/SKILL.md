...
inputs: ["agent role", "risk appetite", "tool permissions", "failure modes", "compliance or business constraints"]
outputs: ["guardrail policy", "allowed/prohibited action tables", "escalation rules", "fallback behavior", "recommended next skill"]
handoffs: ["tool-permission-boundary-checker", "agent-agency-reviewer", "agent-sandbox-reviewer"]
---
# guardrail-policy-writer

## Purpose
Write explicit agent guardrail policies covering allowed actions, prohibited behavior, escalation points, approvals, and safe fallbacks.
...
## Deliverables
- guardrail policy
- allowed/prohibited action tables
- escalation rules
- fallback behavior

...
inputs: ["secrets inventory", "prompt and context paths", "logs and traces", "tool responses", "storage locations"]
outputs: ["secret exposure findings", "high-risk disclosure paths", "redaction and storage recommendations", "monitoring recommendations", "recommended next skill"]
handoffs: ["context-leak-reviewer", "agent-sandbox-reviewer", "guardrail-policy-writer"]
---
# secret-exposure-reviewer

## Purpose
Check whether prompts, tools, logs, traces, memory, or outputs can expose credentials, keys, tokens, or sensitive internal data.
...
- high-risk disclosure paths
- redaction and storage recommendations

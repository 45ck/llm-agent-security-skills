...
inputs: ["system prompt or agent instructions", "prompt assembly logic", "retrieval inputs", "tool invocation paths", "example user and retrieved content"]
outputs: ["prompt injection findings", "attack hypotheses", "risk-ranked injection paths", "mitigation recommendations", "recommended next skill"]
handoffs: ["tool-permission-boundary-checker", "guardrail-policy-writer", "retrieval-trustworthiness-reviewer"]
---

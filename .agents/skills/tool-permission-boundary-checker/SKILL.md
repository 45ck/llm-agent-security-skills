---
name: "tool-permission-boundary-checker"
...
inputs: ["tool list", "tool schemas", "approval rules", "side-effecting actions", "agent role description"]
outputs: ["permission boundary review", "tool risk inventory", "missing approval gates", "least-privilege recommendations", "recommended next skill"]
handoffs: ["agent-agency-reviewer", "guardrail-policy-writer", "agent-sandbox-reviewer"]
---
# tool-permission-boundary-checker

## Purpose
Check whether agent tools, function calls, and external actions are bounded by explicit permissions, approval gates, and least-privilege rules.
